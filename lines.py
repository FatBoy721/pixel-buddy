...
CLEAN = {
    ...
    "update_checking": ["Let me go see if there's a newer me.", "Checking if I've been improved…"],
    "update_none": ["Nope, I'm the newest me there is ({version}).", "Already up to date ({version})."],
    "update_found": ["Ooh, {tag} is out. Grabbing it…"],
    "update_ready": ["Got it. Restarting as {tag}. Back in a sec!"],
    "update_failed": ['Update didn\'t work: "{err}"'],
    "update_source": ["I'm running from source, so: git pull. Opening the releases page anyway."],
    "inspect_start": ["Hold still, let me look under your hood.", "Okay. Let's see what you're working with."],
    "inspecting": ["Hmm. Interesting…", "Squinting at your RAM here…", "Counting your cores…",
                   "Is this thing dusty or is it me?", "Checking what your GPU can handle…",
                   "Ooh, that's a nice chip."],
    "inspect_done": ["Done poking around: {specs}", "Here's what you've got: {specs}"],
    "picks_ready": ["Here's what your rig can run. Pick one and I'll go get it."],
    "install_start": ["Alright, going to get it. Back in a bit.", "Downloading. Don't unplug anything."],
    "installing": ["Reeling it in…", "Dragging it down the pipe…", "This is a big one…",
                   "Almost got it…", "Yanking it out of the cloud…"],
    "install_done": ["Got it. I'm running {model} now. Ask me something.",
                     "Brain installed: {model}. Feels good in here."],
    "install_failed": ['Couldn\'t do it myself: "{err}". Opening the download page instead.'],
    "no_ollama_offer": ["You've got no local brain yet. Want me to check your specs and go get one? "
                        "Right-click me → Brain → Find me a brain."],
...
SPICY = {
    ...
    "no_ai_tip": ["I'm brainless right now, dumbass. Install Ollama (free, private) or Claude Code / Codex, "
                  "then right-click me → Brain."],
    "update_checking": ["Hang on, seeing if there's a less shitty version of me.",
                        "Checking if they fixed me yet."],
    "update_none": ["Nope. I'm as good as I get ({version}). Sorry.",
                    "Already the newest me ({version}). Deal with it."],
    "update_found": ["Oh hell yes, {tag} is out. Grabbing it…"],
    "update_ready": ["Got it. Restarting as {tag}. Don't miss me."],
    "update_failed": ['Update crapped out: "{err}"'],
    "update_source": ["You're running me from source, genius. git pull. Here's the releases page anyway."],
    "inspect_start": ["Pop the hood, let's see what garbage you bought.",
                      "Hold still, I'm gonna go elbow-deep in your specs."],
    "inspecting": ["Hmm. Huh. Interesting…", "Squinting at your damn RAM…", "Counting your cores, hang on…",
                   "When's the last time you dusted this thing?!", "What the hell is this GPU…",
                   "Ooh. Okay. That's actually not bad."],
    "inspect_done": ["Here's your damn machine: {specs}", "Alright, you're packing: {specs}"],
    "picks_ready": ["Here's what this heap can actually run. Pick one, I'll go drag it back."],
    "install_start": ["Fine, I'll go get it my damn self.", "Downloading. Don't touch shit."],
    "installing": ["Reeling this bastard in…", "Dragging it down the damn pipe…", "Holy hell, this is big…",
                   "Come on, come ON…", "Ripping it out of the cloud…"],
    "install_done": ["Done. I'm running {model} now. Try me, smartass.",
                     "{model} installed. I can feel my brain swelling."],
    "install_failed": ['Screw it, it wouldn\'t install: "{err}". Here\'s the download page.'],
    "no_ollama_offer": ["You've got no brain in here, dumbass. Want me to check your specs and go get one? "
                        "Right-click me → Brain → Find me a brain."],
